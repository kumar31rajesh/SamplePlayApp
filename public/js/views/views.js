...
window.DataSetsBuilderView=Backbone.View.extend({
    ...
    events: {
        ...
        "drop 		#dimensionsCol,#ameasuresCol,#tdimensionsCol": "dropMEventD",
        "dragover 	#measuresCol,#dimensionsCol,#ameasuresCol,#tdimensionsCol": function(ev) {
                ev.preventDefault();
            },
 ...
 /*   	
	...
	var toAppendElem;
	switch(e.originalEvent.target.innerHTML.trim().toLowerCase()){
	    case 'dimensions': toAppendElem = '#dimensionsCol';break;
	    case 'measures': toAppendElem = '#ameasuresCol';break;
	    case 'time dimensions': toAppendElem = '#tdimensionsCol';break;
	}
    	
    	$(toAppendElem+" .panel-body").append("<li class=\"list-group-item\">"+found.datasource+"."+found.name+"</li>");
