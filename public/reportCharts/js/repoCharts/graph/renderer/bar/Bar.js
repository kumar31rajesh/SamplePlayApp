RepoCharts.namespace('RepoCharts.Graph.Renderer.Bar');

RepoCharts.Graph.Renderer.Bar = RepoCharts.Class.create( RepoCharts.Graph.Renderer, {

	name: 'bar',

	defaults: function($super) {

		var defaults = RepoCharts.extend( $super(), {
			gapSize: 0.05,
			unstack: false
		} );
	...
	_frequentInterval: function(data) {
		...
		RepoCharts.keys(intervalCounts).forEach( function(i) {
