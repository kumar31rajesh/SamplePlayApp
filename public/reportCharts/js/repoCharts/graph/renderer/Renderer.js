RepoCharts.namespace("RepoCharts.Graph.Renderer");

RepoCharts.Graph.Renderer = RepoCharts.Class.create( {
	...
	configure: function(args) {
		...
		RepoCharts.keys(this.defaults()).forEach( function(key) {
			...
			if (typeof this.defaults()[key] == 'object') {
				...
				RepoCharts.keys(this.defaults()[key]).forEach( function(k) {
